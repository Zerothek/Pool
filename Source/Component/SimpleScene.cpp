...
void SimpleScene::InitResources()
{
	...
	// Green
	{
		...
		shader->AddShader(RESOURCE_PATH::SHADERS + "GreenFragmentShader.glsl", GL_FRAGMENT_SHADER);
		shader->CreateAndLink();
		shaders[shader->GetName()] = shader;
	}
	...
	// Halves
	{
		Shader *shader = new Shader("Halves");
		shader->AddShader(RESOURCE_PATH::SHADERS + "VertexShader.glsl", GL_VERTEX_SHADER);
		shader->AddShader(RESOURCE_PATH::SHADERS + "HalvesFragmentShader.glsl", GL_FRAGMENT_SHADER);
		shader->CreateAndLink();
		shaders[shader->GetName()] = shader;
	}
	...
	// Full
	{
		Shader *shader = new Shader("Full");
		shader->AddShader(RESOURCE_PATH::SHADERS + "VertexShader.glsl", GL_VERTEX_SHADER);
		shader->AddShader(RESOURCE_PATH::SHADERS + "FullFragmentShader.glsl", GL_FRAGMENT_SHADER);
		shader->CreateAndLink();
		shaders[shader->GetName()] = shader;
	}
	...
	// Black
	{
		Shader *shader = new Shader("Black");
		shader->AddShader(RESOURCE_PATH::SHADERS + "VertexShader.glsl", GL_VERTEX_SHADER);
		shader->AddShader(RESOURCE_PATH::SHADERS + "BlackFragmentShader.glsl", GL_FRAGMENT_SHADER);
		shader->CreateAndLink();
		shaders[shader->GetName()] = shader;
	}
	...
	// Cue
	{
		Shader *shader = new Shader("Cue");
		shader->AddShader(RESOURCE_PATH::SHADERS + "VertexShader.glsl", GL_VERTEX_SHADER);
		shader->AddShader(RESOURCE_PATH::SHADERS + "CueFragmentShader.glsl", GL_FRAGMENT_SHADER);
		shader->CreateAndLink();
		shaders[shader->GetName()] = shader;
	}
	...
	// Cue Animation
	{
		Shader *shader = new Shader("CueAnimation");
		shader->AddShader(RESOURCE_PATH::SHADERS + "CueAnimationVertexShader.glsl", GL_VERTEX_SHADER);
		shader->AddShader(RESOURCE_PATH::SHADERS + "CueFragmentShader.glsl", GL_FRAGMENT_SHADER);
		shader->CreateAndLink();
		shaders[shader->GetName()] = shader;
	}
	...
	// Manta
	{
		Shader *shader = new Shader("Manta");
		shader->AddShader(RESOURCE_PATH::SHADERS + "VertexShader.glsl", GL_VERTEX_SHADER);
		shader->AddShader(RESOURCE_PATH::SHADERS + "MantaFragmentShader.glsl", GL_FRAGMENT_SHADER);
		shader->CreateAndLink();
		shaders[shader->GetName()] = shader;
	}
	...
	// White
	{
		...
		shader->AddShader(RESOURCE_PATH::SHADERS + "VertexShader.glsl", GL_VERTEX_SHADER);
		shader->AddShader(RESOURCE_PATH::SHADERS + "WhiteFragmentShader.glsl", GL_FRAGMENT_SHADER);
		shader->CreateAndLink();
		shaders[shader->GetName()] = shader;
	}
